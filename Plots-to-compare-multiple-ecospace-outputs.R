...
for (init in scaling_list){
  ...
  ## Plot output names
  dir_pdf_out  = "./Scenario_comps/PDF_plots/"
  ...
  ## Folder name based on `init_years_toscale`
  folder_name <- paste0("Fit_metrics_scaled_", init_years_toscale, "y")
  
  ## Create the folder if it doesn't exist
  folder_path <- paste0("./Scenario_comps/Tables/", folder_name)
